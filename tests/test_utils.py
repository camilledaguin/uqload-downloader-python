...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("https://uqload.is/embed-xxxxxxxxxxxx"),
        ("https://uqload.is/embed-embed-embed-xxxxxxxxxxx"),
        ("https://uqload.is/xxxxxxxxxxx"),
        ("https://www.uqload.is/-xxxxxxxxxxxx.html"),
        ("https://www.uqload.is/e-xxxxxxxxxxxx.html"),
        ("https://www.uqload.is/.html"),
        ("https://www.uqload.is"),
        ("https://uqload.is/embed-.html"),
        ("https://open.spotify.com/track/2ctvdKmETyOzPb2GiJJT53?si=52ba32b25f9a4a45"),
        ("uqload.is/embed-xxxxxxxxxxxx.html"),
        ("xxxxxxxxxxxx"),
        ("xxxxxxxxxxxx.html"),
    ],
)
...
@pytest.mark.parametrize(
    "url",
    [
        ("https://uqload.is/embed-xxxxxxxxxxxx.html"),
        ("https://www.uqload.is/embed-xxxxxxxxxxxx.html"),
        ("https://uqload.is/embed-xxxxxxxxxxxx.html"),
        ("https://uqload.is/embed-xxxxxxxxxxxx.html"),
        ("http://uqload.is/embed-xxxxxxxxxxxx.html"),
        ("https://uqload.is/embed-xxxxxxxxxxxx.html"),
        ("https://uqload.is/embed-xxxxxxxxxxxx.html"),
        ("https://uqload.is/xxxxxxxxxxxx.html"),
        ("https://www.uqload.is/xxxxxxxxxxxx.html"),
    ],
)
